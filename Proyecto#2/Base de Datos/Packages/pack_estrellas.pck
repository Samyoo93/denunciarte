...
PROCEDURE calificarEntidad (pnota VARCHAR2, pdescripcion VARCHAR2,pcedulaUsuario_id NUMBER, pcalificacion NUMBER, pCedulaEntidad NUMBER);
...
PROCEDURE calificarEntidad (pnota VARCHAR2, pdescripcion VARCHAR2,pcedulaUsuario_id NUMBER, pcalificacion NUMBER, pCedulaEntidad NUMBER)AS
  BEGIN
    INSERT INTO review (review_id,nota,descripcion,calificacion,cedulausuario_id)
    VALUES (s_review.nextval,pnota,pdescripcion,pcalificacion,pcedulaUsuario_id);
