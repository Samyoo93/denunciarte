<?php
    ...
    */
    ...
    $title = "<h2 style='position:absolute; top:200px; left:70px;'>Dirección</h2>
	...
	$provincia="	<select name='provincia' required id='provincia' onchange='refresh(2)'
                        style='position:absolute; left:200px; top:300px; width:300px;'>
					   <option value=''>Seleccione uno</option>";

	$canton="		<select name='canton' required id='canton' onchange='refresh(3)'
                        style='position:absolute; left:200px; top:330px; width:300px;'>
					   <option value=''>Seleccione uno</option>";

    $distrito="		<select name='distrito' required id='distrito' onchange='refresh(4)'
                        style='position:absolute; left:200px; top:360px; width:300px;'>
					   <option value=''>Seleccione uno</option>";
    $barrio="		<select name='barrio' required id='barrio' onchange='refresh(5)'
                        style='position:absolute; top:390px; text-align:center; left:200px; width:300px;'>
						<option value=''>Seleccione uno</option>";
	...
	$sql = "SELECT nombre FROM pais";
        ...
        style='position:absolute; left:200px; top:270px; width:300px;'>";
