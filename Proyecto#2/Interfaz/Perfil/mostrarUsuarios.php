...
<!--
    ...
    Nombre del archivo: mostrarUsuarios.php
    Descripción: Permite mostrar la información del usuario que
    realiza un comentario, desde esta página se puede reportar
    a este usuario.
